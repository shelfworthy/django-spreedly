...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('spreedly_plan', (
            ...
            ('force_recurring', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('feature_level', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=6, decimal_places=2)),
            ...
            ('force_renew', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ...
        db.create_table('spreedly_subscription', (
            ...
            ('feature_level', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('trial_elegible', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('card_expires_before_next_auto_renew', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('lifetime', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),

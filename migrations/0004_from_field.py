...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Gift.from_user'
        db.delete_column('spreedly_gift', 'from_user_id')

        # Adding field 'Gift.from_name'
        db.add_column('spreedly_gift', 'from_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Gift.from_email'
        db.add_column('spreedly_gift', 'from_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Gift.from_user'
        db.add_column('spreedly_gift', 'from_user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='gifts_sent', to=orm['auth.User']), keep_default=False)

        # Deleting field 'Gift.from_name'
        db.delete_column('spreedly_gift', 'from_name')

        # Deleting field 'Gift.from_email'
        db.delete_column('spreedly_gift', 'from_email')
    ...
    models = {
        ...
        'spreedly.gift': {
            ...
            'from_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.notification_sent'
        db.add_column('spreedly_subscription', 'notification_sent', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Subscription.notification_sent'
        db.delete_column('spreedly_subscription', 'notification_sent')

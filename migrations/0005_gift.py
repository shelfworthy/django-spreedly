...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.gift'
        db.add_column('spreedly_subscription', 'gift', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Subscription.gift'
        db.delete_column('spreedly_subscription', 'gift')
